...
此模板\cite{Brown1984}使用了 Bib\TeX{} 来生成参考文献\cite{HainnuThesis}，也可以使用\cite{ZHY2012manifold,CDIO2014} \lstinline|biblatex| 宏包，在中文示例中，使用了 \lstinline|gbt7714| 宏包。参考文献示例： 使用了中国一个大型的 P2P 平台（人人贷）的数据来检验男性投资者和女性投资者在投资表现上是否有显著差异。
